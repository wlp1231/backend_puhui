<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="区名" prop="area">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['common:areas:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['common:areas:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="areasList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="区名" align="center" prop="area" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="区名" prop="area">
          <el-input v-model="form.area" placeholder="请输入区名" />
        </el-form-item>
        <el-form-item label="市ID" prop="cityid">
...
<script>
import { listAreas, getAreas, delAreas, addAreas, updateAreas, exportAreas } from "@/api/system/areas";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除区编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有区数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
          this.exportLoading = true;
          return exportAreas(queryParams);
        }).then(response => {

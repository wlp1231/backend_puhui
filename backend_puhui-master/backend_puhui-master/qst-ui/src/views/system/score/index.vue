...
<!--      <el-table-column label="企业ID" align="center" prop="comId" />-->
      ...
      <el-table-column label="更新详情" align="center" prop="updateDetail" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="积分值" prop="scoreNum">
          <el-input v-model="form.scoreNum" placeholder="请输入积分值" />
        </el-form-item>
        <el-form-item label="更新详情" prop="updateDetail">
          <el-input v-model="form.updateDetail" placeholder="请输入更新详情" />
        </el-form-item>
      </el-form>
...
<script>
import { listScore, getScore, delScore, addScore, updateScore, exportScore,getCompanyName } from "@/api/system/score";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除用户积分编号为"' + scoreIds + '"的数据项?', "警告", {

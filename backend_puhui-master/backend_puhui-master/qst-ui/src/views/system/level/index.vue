...
<!--        <el-button icon="el-icon-refresh" size="mini" @click="resetQuery">重置</el-button>-->
    ...
    <el-table v-loading="loading" :data="levelList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" prop="levelId" />
      <el-table-column label="开始分数" align="center" prop="scoreStart" />
      <el-table-column label="结束分数" align="center" prop="scoreEnd" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="开始分数" prop="scoreStart">
          <el-input v-model="form.scoreStart" placeholder="请输入开始分数" />
        </el-form-item>
        <el-form-item label="结束分数" prop="scoreEnd">
          <el-input v-model="form.scoreEnd" placeholder="请输入结束分数" />
        </el-form-item>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除等级设置编号为"' + levelIds + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有等级设置数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(() => {
